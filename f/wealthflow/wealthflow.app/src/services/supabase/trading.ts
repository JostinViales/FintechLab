...
// In Windmill mode, auth is handled by Windmill itself.
// Use the configured user ID or fall back to a default for single-user setup.
const WINDMILL_USER_ID = import.meta.env.VITE_USER_ID || 'default-user';

async function getCurrentUserId(): Promise<string> {
  return WINDMILL_USER_ID;
}
